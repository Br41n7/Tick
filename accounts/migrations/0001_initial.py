    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('ordinary_user', 'Ordinary User'), ('artist', 'Artist'), ('host', 'Host'), ('admin', 'Admin')], default='ordinary_user', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('request_type', models.CharField(choices=[('to_artist', 'Upgrade to Artist'), ('to_host', 'Upgrade to Host')], max_length=20)),
